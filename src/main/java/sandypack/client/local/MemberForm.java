package sandypack.client.local;
...
import sandypack.client.shared.Member;
import sandypack.client.shared.MemberService;
 ...
 */
@Templated("KitchenSinkApp.html#memberForm")
public class MemberForm extends Composite {
   ...
   * the {@link #onRegisterButtonClick(ClickEvent)} method when that happens.
